...
PACKAGES = ["sense2vec", "sense2vec.tests"]

MOD_NAMES = ["sense2vec.vectors", "sense2vec.cfile", "sense2vec._strings"]
...
compile_options = {
    "msvc": ["/Ox", "/EHsc"],
    "other": ["-O3", "-Wno-unused-function", "-fno-stack-protector"],
}
link_options = {"msvc": [], "other": ["-fno-stack-protector"]}


if os.environ.get("USE_BLAS") == "1":
    compile_options["other"].extend(["-DUSE_BLAS=1", "-fopenmp"])
# else:
